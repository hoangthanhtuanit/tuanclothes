                            ...
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="text-input" name="title" value="<?php isset($_POST['title']) ? $_POST['title'] : '' ?>" placeholder="Tiêu đề tin"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class=" form-control-label">Nội dung tin tức (<span
                                                    style="color: red;">*</span>)</label>
                                    </div>
                                    <div class="col-12 col-md-9">
