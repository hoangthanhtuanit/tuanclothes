<?php
  ...
  class NL_CheckOutV3
  {
		...
		function VisaCheckout($order_code,$total_amount,$payment_type,$order_description,$tax_amount,
									$fee_shipping,$discount_amount,$return_url,$cancel_url,$buyer_full_name,$buyer_email,$buyer_phone_number,
									$buyer_address,$array_items,$bank_code) 
				{
				 $params = array(
						...
						'buyer_full_name'		=> $buyer_full_name, //Tên người mua hàng
						'buyer_email'			=> $buyer_email, //Địa chỉ Email người mua
						'buyer_phone_number'			=> $buyer_phone_number, //Điện thoại người mua
	...
	function PrepaidVisaCheckout($order_code, $total_amount, $payment_type, $order_description, $tax_amount, $fee_shipping, $discount_amount, $return_url, $cancel_url, $buyer_full_name, $buyer_email, $buyer_phone_number, $buyer_address, $array_items, $bank_code) {
        $params = array(
            'cur_code'				=>	$this->cur_code,
			'function'				=> 'SetExpressCheckout',
			'version'				=> $this->version,
	...
	function IBCheckout($order_code, $total_amount, $bank_code, $payment_type, $order_description, $tax_amount, $fee_shipping, $discount_amount, $return_url, $cancel_url, $buyer_full_name, $buyer_email, $buyer_phone_number, $buyer_address, $array_items) {
        $params = array(
            'cur_code' => $this->cur_code,
            'function' => 'SetExpressCheckout',
            'version' => $this->version,
	...
	function GetErrorMessage($error_code) {
				...
				'129' => 'buyer_full_name không hợp lệ',
				'130' => 'buyer_email không hợp lệ',
				'131' => 'buyer_phone_number không hợp lệ',
